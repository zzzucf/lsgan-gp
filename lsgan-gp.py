...
parser.add_argument('--slope', type=float, default=0.1, help='slope for function c proposed in generalized lsgan, when slope is 0, gls-gan is lsgan, when slope is 1 gls-gan is wgan.')
